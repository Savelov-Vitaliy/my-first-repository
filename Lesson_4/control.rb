...
def start
  loop do
    begin
      ...
      break if $input[0] == "0"
      puts "Ошибка! Что то пошло не так"       
      puts "Возможные причины: неверная команда или обращение к несуществующему поезду, станции или маршруту"       
...
def help
  ...
  puts ""    
  puts "Пример ввода команд: s (ввод), sa.первая станция Москва (ввод), tca.грузовой поезд Силач (ввод)"    
  puts ""    
end
